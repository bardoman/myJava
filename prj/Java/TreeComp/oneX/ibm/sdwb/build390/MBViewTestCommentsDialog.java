...
/***************************************************************************/
//Thulasi: 10/19/00
/* Java MBViewTestCommentsDialog class for the Build/390 client             */
/*  Builds a text field to show the Apar test comments */
/***************************************************************************/
import java.awt.*;
...
public class MBViewTestCommentsDialog extends MBBasicInternalFrame {

    private JTextArea view;
    private boolean dirty = false;
    String referenceText = new String();
    String fn = new String();
    private MBViewTestCommentsDialog thisFrame = null;
    private boolean addTextFlag = false;

    public MBViewTestCommentsDialog(final String tempFn) {
