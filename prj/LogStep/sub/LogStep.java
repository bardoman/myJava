...
public class LogStep extends JFrame
{
    ...
    static String BROWSE_PATH_STORE = "BrowsePath";
...
//
    ...
    /**
     * Create a new instance of LogStep with default title.
     * @see #LogStep(String title)
     */
    public LogStep()
    {
        this("LogStep");
    ...
    void menuitemOpen_Action(ActionEvent event)
    {
        try
        {
            ...
            JFileChooser fileDialog = new JFileChooser(new File(getBrowsePath()));
    ...
    void storeBrowsePath(String path)
    {
        try
        {
            File fil = new File(BROWSE_PATH_STORE);
    ...
    String getBrowsePath()
    {
        ...
        try
        {
            ...
            LineNumberReader rd = new LineNumberReader(new FileReader(BROWSE_PATH_STORE));
