...
{
   ImageIcon iconAbout = new ImageIcon(Tiger.class.getResource("images/about.gif"));
   JMenuItem menuItemAbout = new JMenuItem();
   JMenu menuItemHelp = new JMenu();
   ImageIcon iconPaste = new ImageIcon(Tiger.class.getResource("images/paste.gif"));
   JMenuItem menuItemPaste = new JMenuItem();
   ImageIcon iconCopy = new ImageIcon(Tiger.class.getResource("images/copy.gif"));
   JMenuItem menuItemCopy = new JMenuItem();
   ImageIcon iconCut = new ImageIcon(Tiger.class.getResource("images/cut.gif"));
   JMenuItem menuItemCut = new JMenuItem();
   JMenu menuEdit = new JMenu();
   JMenuItem menuItemExit = new JMenuItem();
   JMenuItem menuItemSave_As = new JMenuItem();
   ImageIcon iconSave = new ImageIcon(Tiger.class.getResource("images/save.gif"));
   JMenuItem menuItemSave = new JMenuItem();
   ImageIcon iconOpen = new ImageIcon(Tiger.class.getResource("images/open.gif"));
   JMenuItem menuItemOpen = new JMenuItem();
   ImageIcon iconNew = new ImageIcon(Tiger.class.getResource("images/new.gif"));
   ...
   protected void tbAddButtons(JToolBar toolbar) {
       ...
       buttonAbout.setToolTipText("It's a TIGER Baby!");
   ...
   /**
    * Generated by the SlickEdit Java GUI Builder
    */
   private void initComponents() {
      ...
      this.addWindowListener(new Tiger_WindowAdapter(this));
      ...
      menuItemOpen.addActionListener(new Tiger_Open_jMenuItem2_ActionAdapter(this));
      ...
      menuItemSave_As.addActionListener(new Tiger_Save_As_jMenuItem3_ActionAdapter(this));
      menuFile.add(menuItemSave_As);
      menuFile.addSeparator();
      menuItemExit.setText("Exit");
      menuItemExit.addActionListener(new Tiger_menuItemExit_ActionAdapter(this));
      ...
      menuItemAbout.addActionListener(new Tiger_About_jMenuItem8_ActionAdapter(this));
   ...
   void Tiger_windowClosing(java.awt.event.WindowEvent e0) {
      menuItemExit_actionPerformed(null);
   }
}

class Tiger_WindowAdapter extends WindowAdapter {
   Tiger adaptee;
   Tiger_WindowAdapter(Tiger adaptee) {
      this.adaptee=adaptee;
   }
   public void windowClosing(java.awt.event.WindowEvent e0) {
      adaptee.Tiger_windowClosing(e0);
   }
}

class Tiger_Open_jMenuItem2_ActionAdapter implements ActionListener {
   Tiger adaptee;
   Tiger_Open_jMenuItem2_ActionAdapter(Tiger adaptee) {
      this.adaptee=adaptee;
   }
...
class Tiger_Save_As_jMenuItem3_ActionAdapter implements ActionListener {
   Tiger adaptee;
   Tiger_Save_As_jMenuItem3_ActionAdapter(Tiger adaptee) {
      this.adaptee=adaptee;
   }
   public void actionPerformed(java.awt.event.ActionEvent e0) {
...
class Tiger_menuItemExit_ActionAdapter implements ActionListener {
   Tiger adaptee;
   Tiger_menuItemExit_ActionAdapter(Tiger adaptee) {
      this.adaptee=adaptee;
   }
   public void actionPerformed(java.awt.event.ActionEvent e0) {
...
class Tiger_About_jMenuItem8_ActionAdapter implements ActionListener {
   Tiger adaptee;
   Tiger_About_jMenuItem8_ActionAdapter(Tiger adaptee) {
      this.adaptee=adaptee;
   }
   public void actionPerformed(java.awt.event.ActionEvent e0) {
