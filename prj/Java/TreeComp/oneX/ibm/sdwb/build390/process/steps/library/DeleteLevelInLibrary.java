...
public class DeleteLevelInLibrary extends ProcessStep {
	static final long serialVersionUID = 1111111111111111L;

	private ChangesetGroup sourceInfo = null;

	public DeleteLevelInLibrary(ChangesetGroup tempInfo, com.ibm.sdwb.build390.process.AbstractProcess tempProc) {
		super(tempProc,"Delete object in library");
	...
	public void execute() throws com.ibm.sdwb.build390.MBBuildException{
        ...
        getStatusHandler().updateStatus("Delete " + sourceInfo.getName() + " in library ",false);
		sourceInfo.delete();
	}
}
