...
public class ReplaceMetadataInHostAndLibraryFrame extends AbstractReplaceFrame {



    public  ReplaceMetadataInHostAndLibraryFrame(MBInternalFrame pFrame,LogEventProcessor lep) throws MBBuildException {
        super("Replace(Host & Library)", pFrame, lep);
    }


    /*override in subclasses to point to the right link */
    public void helpAction() {
        MBUtilities.ShowHelp("",HelpTopicID.REPLACE_METADATA_HOST_CMVC_HELP);
