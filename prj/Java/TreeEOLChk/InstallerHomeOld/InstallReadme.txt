******************************************************************
Build/390 SDWB 5.0.0:0.14 Install/UnInstall Instructions
******************************************************************
...
3.) Perform a new(clean) Build390 5.0.0:0.14 or above  installation.
...
Windows - <INSTALL>:
-------------------
1.) Download the Installer package WINCB390_50_14.EXE into the root 
...
GUI Mode:
=========
1.) Download the Installation package "WINCB390_50_14.EXE"

2.) Execute the installation package "WINCB390_50_14.EXE" to expand
...
eg  :/usr/lpp/java/IBM/J1.4.1, assuming that
     the   java    executable   resides in
     /usr/lpp/java/IBM/J1.4.1/bin directory.
==========================================
>>Enter  the  java executable  path in uss
(hit enter to accept /usr/lpp/java/IBM/J1.3/
as     the     default),      or
(enter a different jre path), or
(enter 'quit' to exit)?
==========================================
A    valid   java   executable   found    in
/usr/lpp/java/IBM/J1.4.1/bin
(Figure:DIALOG -B)                   
========================================== 
Choose Install/Rollback/UnInstall
========================================== 
...
==========================================
>>Enter  the  java executable  path in uss
(hit enter to accept /usr/lpp/java/IBM/J1.4.1/
as     the     default),      or
(enter a different jre path), or
(enter 'quit' to exit)?
==========================================
