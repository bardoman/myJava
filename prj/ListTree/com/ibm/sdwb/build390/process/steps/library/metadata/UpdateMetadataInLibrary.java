...
public class UpdateMetadataInLibrary extends ProcessStep {
    ...
    public UpdateMetadataInLibrary(Set parts , LibraryInfo tempInfo, ReleaseInformation tempRelease, com.ibm.sdwb.build390.process.AbstractProcess tempProc) {
        super(tempProc,"Update metadata in library for " + tempRelease.getLibraryName());
    ...
    public void execute() throws MBBuildException  {
        ...
        libInfo.getMetadataOperationsHandler().storeMetadataValuesFromPassedInfos(parts);
    }
}
