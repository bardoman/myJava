...
{
   ImageIcon iconAbout = new ImageIcon(test.class.getResource("images/about.gif"));
   JMenuItem menuItemAbout = new JMenuItem();
   JMenu menuItemHelp = new JMenu();
   ImageIcon iconPaste = new ImageIcon(test.class.getResource("images/paste.gif"));
   JMenuItem menuItemPaste = new JMenuItem();
   ImageIcon iconCopy = new ImageIcon(test.class.getResource("images/copy.gif"));
   JMenuItem menuItemCopy = new JMenuItem();
   ImageIcon iconCut = new ImageIcon(test.class.getResource("images/cut.gif"));
   JMenuItem menuItemCut = new JMenuItem();
   JMenu menuEdit = new JMenu();
   JMenuItem menuItemExit = new JMenuItem();
   JMenuItem menuItemSave_As = new JMenuItem();
   ImageIcon iconSave = new ImageIcon(test.class.getResource("images/save.gif"));
   JMenuItem menuItemSave = new JMenuItem();
   ImageIcon iconOpen = new ImageIcon(test.class.getResource("images/open.gif"));
   JMenuItem menuItemOpen = new JMenuItem();
   ImageIcon iconNew = new ImageIcon(test.class.getResource("images/new.gif"));
   ...
   private void initComponents() {
      ...
      this.addWindowListener(new test_WindowAdapter(this));
      ...
      menuItemOpen.addActionListener(new test_Open_jMenuItem2_ActionAdapter(this));
      ...
      menuItemSave_As.addActionListener(new test_Save_As_jMenuItem3_ActionAdapter(this));
      menuFile.add(menuItemSave_As);
      menuFile.addSeparator();
      menuItemExit.setText("Exit");
      menuItemExit.addActionListener(new test_menuItemExit_ActionAdapter(this));
      ...
      menuItemAbout.addActionListener(new test_About_jMenuItem8_ActionAdapter(this));
   ...
   void test_windowClosing(java.awt.event.WindowEvent e0) {
      menuItemExit_actionPerformed(null);
   }
}

class test_WindowAdapter extends WindowAdapter {
   test adaptee;
   test_WindowAdapter(test adaptee) {
      this.adaptee=adaptee;
   }
   public void windowClosing(java.awt.event.WindowEvent e0) {
      adaptee.test_windowClosing(e0);
   }
}

class test_Open_jMenuItem2_ActionAdapter implements ActionListener {
   test adaptee;
   test_Open_jMenuItem2_ActionAdapter(test adaptee) {
      this.adaptee=adaptee;
   }
...
class test_Save_As_jMenuItem3_ActionAdapter implements ActionListener {
   test adaptee;
   test_Save_As_jMenuItem3_ActionAdapter(test adaptee) {
      this.adaptee=adaptee;
   }
   public void actionPerformed(java.awt.event.ActionEvent e0) {
...
class test_menuItemExit_ActionAdapter implements ActionListener {
   test adaptee;
   test_menuItemExit_ActionAdapter(test adaptee) {
      this.adaptee=adaptee;
   }
   public void actionPerformed(java.awt.event.ActionEvent e0) {
...
class test_About_jMenuItem8_ActionAdapter implements ActionListener {
   test adaptee;
   test_About_jMenuItem8_ActionAdapter(test adaptee) {
      this.adaptee=adaptee;
   }
   public void actionPerformed(java.awt.event.ActionEvent e0) {
