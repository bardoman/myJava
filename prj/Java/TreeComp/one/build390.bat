...
.\jre\bin\java -mx400m -classpath %B390_CLASSPATH% Build390.MBClient %* 

GOTO END

:NO_DOS_WIN

START .\jre\bin\javaw -mx400m -classpath %B390_CLASSPATH% Build390.MBClient %* 
...
.\jre\bin\java -mx400m -classpath %B390_CLASSPATH% Build390.MBClient %1 

GOTO END

:NO_DOS_WIN2

START .\jre\bin\javaw -mx400m -classpath %B390_CLASSPATH% Build390.MBClient %1 
