...
/** to-do:this is essentially the same code as FindMetadataInHostAndCmvcFrame. we basically have to coalesce 
 * those two into a single class. (with an additional title as input)
 */ 
public class FindMetadataInLibraryFrame extends AbstractFindFrame {
    //begin TST2211
    java.util.List keyWords;
    boolean keyWordValid=false;
    //end TST2211

    public  FindMetadataInLibraryFrame(MBInternalFrame pFrame, String keyWords[], LogEventProcessor lep) throws MBBuildException {
        super("Find(Library)", pFrame, lep);
    ...
    {
        MBUtilities.ShowHelp("",HelpTopicID.FILTER_METADATA_CMVC_HELP);
