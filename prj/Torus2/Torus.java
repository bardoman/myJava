...
public class Torus
{
    ...
    {  
        ...
        {
            LineNumberReader rd = new LineNumberReader(new FileReader(fileName[i]));
    ...
    public static void main(String args[])
    {
        ...
        else
        {
            ...
            try
            {
                ...
                fileNames[0]=args[1];
                fileNames[1]="msg2.txt";

               // new Torus(Integer.valueOf(args[0]).intValue(),fileNames,randFill);
               new Torus(10,fileNames,false);
            }
            catch(Exception e)
            {
